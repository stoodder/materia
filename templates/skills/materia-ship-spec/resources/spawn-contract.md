...
The verbatim boilerplate the `materia-ship-spec` orchestrator copies into subagent
...
`materia-ship-spec/SKILL.md` § Retrospective capture (the schema lives there — the
