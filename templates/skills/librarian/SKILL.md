...
counterpart to `/janitor` — the janitor sweeps the code, the librarian sweeps
...
- **Writes no queue entries** — suspected code bugs become needs-human notes
  ...
  report, the operator runs `/report-bug` afterward.
