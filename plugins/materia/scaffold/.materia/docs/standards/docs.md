...
- **Present state only.** Describe the code as it **is**. Never narrate how it
  ...
  `.materia/docs/specs/**` own the past; a doc that narrates it goes stale twice.
...
- Every file under `.materia/docs/` root, `.materia/docs/resources/`, `.materia/docs/standards/`, and
  `.materia/docs/_templates/`, plus `CLAUDE.md`.
