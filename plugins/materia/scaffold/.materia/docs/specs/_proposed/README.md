...
| `curator` | `curator` | Oversized **visual** work from a live-app sweep — a UI-standards change too large or too behavioral to fix in the presentation-layer envelope that needs a product/design decision (§ Maintainer lifecycle § Oversized findings, [`../../standards/skills.md`](../../standards/skills.md)); the bounded rest is fixed directly in the curator's own PR. |
| `concierge` | `concierge` | Oversized **experience** work from a live-app sweep — a flow / interaction / a11y change too large or too behavioral to fix in the presentation-layer envelope that needs a product/design decision (§ Maintainer lifecycle § Oversized findings, [`../../standards/skills.md`](../../standards/skills.md)); the bounded rest is fixed directly in the concierge's own PR. |
